    ...
    <div className={`app-container ${isSidebarOpen ? 'sidebar-open' : 'sidebar-closed'}`}>
      ...
      <div className={`sidebar ${isSidebarOpen ? 'open' : 'closed'}`}>
        ...
        <div className="sidebar-menu">
          ...
          <div className="menu-item" onClick={() => handleNavigation('/route/virtual-doctor')}>
            <i className="fas fa-user-md"></i>
            <span>Virtual Doctor</span>
          </div>
          <div className="menu-item" onClick={() => handleNavigation('/route/requests')}>
            <i className="fas fa-clipboard-list"></i>
            <span>View Request Access</span>
          </div>
          <div className="menu-item" onClick={() => handleNavigation('/route/community')}>
            <i className="fas fa-users"></i>
            <span>Community</span>
          </div>
          <div className="menu-item" onClick={() => handleNavigation('/route/vibesync')}>
