...
function DocumentUpload() {
  ...
  const getHealthScoreColor = (score) => {
    ...
    if (score >= 60) return "#ff9800"; // Yellow
    return "#f44336"; // Red
  };
    ...
    <div className="container">
      ...
      <div className="app-header">
        ...
        <div className="logo-icon">
          ...
          <div>
            <h1 className="app-name">AROGYAKOSH</h1>
            <p className="app-description">Secure Medical Document Management</p>
          </div>
        </div>
      </div>
      ...
      <div className="content">
        ...
        <form ref={formRef} id="uploadForm" encType="multipart/form-data" onSubmit={handleUpload}>
          <div className="input-group">
            ...
            <input type="text" id="name" name="name" placeholder="Enter a name for your medical document" required />
          </div>
          ...
          <div className="checkbox-container">
            <input
              ...
              defaultChecked
            />
            <label htmlFor="generateSummary">Generate a health analysis from this document</label>
          </div>
          <p className="checkbox-info">AROGYAKOSH will analyze the document to provide personalized health insights and recommendations</p>
